<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="主观得分" prop="zhuguandefen">
          <el-input v-model="ruleForm.zhuguandefen" 
              placeholder="主观得分" clearable  :readonly="ro.zhuguandefen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="主观得分" prop="zhuguandefen">
              <el-input v-model="ruleForm.zhuguandefen" 
                placeholder="主观得分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="客观得分" prop="keguandefen">
          <el-input v-model="ruleForm.keguandefen" 
              placeholder="客观得分" clearable  :readonly="ro.keguandefen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="客观得分" prop="keguandefen">
              <el-input v-model="ruleForm.keguandefen" 
                placeholder="客观得分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	fabushijian : false,
      ...
      rules: {
          ...
          zhuguandefen: [
                { required: true, message: '主观得分不能为空', trigger: 'blur' },
                { validator: validateIntNumber, trigger: 'blur' },
          ],
          keguandefen: [
                { required: true, message: '客观得分不能为空', trigger: 'blur' },
                { validator: validateIntNumber, trigger: 'blur' },
          ],
          zongfen: [
  ...
  computed: {
    zongfen: {
      get: function () {
        return 0+parseFloat(this.ruleForm.zhuguandefen==""?0:this.ruleForm.zhuguandefen)+parseFloat(this.ruleForm.keguandefen==""?0:this.ruleForm.keguandefen) || 0
      }
    },
  },
  created() {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xueshengxingming = true;
          ...
          if(o=='zhuguandefen'){
            this.ruleForm.zhuguandefen = obj[o];
	    this.ro.zhuguandefen = true;
            continue;
          }
          if(o=='keguandefen'){
            this.ruleForm.keguandefen = obj[o];
	    this.ro.keguandefen = true;
            continue;
          }
          if(o=='zongfen'){
