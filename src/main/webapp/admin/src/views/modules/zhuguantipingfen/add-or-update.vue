    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="解释" prop="jieshi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="解释"
                  v-model="ruleForm.jieshi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jieshi" label="解释" prop="jieshi">
                    <span>{{ruleForm.jieshi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xueshengxingming = true;
          ...
          if(o=='defen'){
            this.ruleForm.defen = obj[o];
	    this.ro.defen = true;
            continue;
          }
          if(o=='jieshi'){
            this.ruleForm.jieshi = obj[o];
	    this.ro.jieshi = true;
            continue;
          }
          if(o=='shijian'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zhuguantipingfen/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zhuguantipingfenCrossAddOrUpdateFlag = false;
                  this.parent.search();
