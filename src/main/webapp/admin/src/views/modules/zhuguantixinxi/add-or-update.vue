<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="分值" prop="fenzhi">
          <el-input v-model="ruleForm.fenzhi" 
              placeholder="分值" clearable  :readonly="ro.fenzhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="分值" prop="fenzhi">
              <el-input v-model="ruleForm.fenzhi" 
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zhuguantixinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zhuguantixinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
